...
def main(argv):
    ...
    if FLAGS.projection_head_selector == 0:
        ...
        proj_head = md.Projection_Head(2208, FLAGS.projection_head_selector).cuda()

    #Build supervised head
    sup_head = md.Supervised_Head(proj_head.output if proj_head is not None else 2208, FLAGS.number_of_classes).cuda()
