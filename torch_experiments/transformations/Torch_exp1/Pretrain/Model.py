...
#         super(Projection_Head, self).__init__()
#         self.projection_dim = 128
#         self.mid_layer = nn.Linear(inputs, inputs, bias=True)
#         self.mid_bn = nn.BatchNorm1d(inputs)
#         self.relu = nn.ReLU()
#         self.last_layer = nn.Linear(inputs, self.projection_dim, bias=False)
#         self.last_bn = nn.BatchNorm1d(self.projection_dim, affine=False)
