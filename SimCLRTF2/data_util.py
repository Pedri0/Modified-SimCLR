...
def random_color_jitter(image, p=1.0, impl='simclrv2'):
    ...
    def _transform(image):
        color_jitter_t = functools.partial(color_jitter, strenght=FLAGS.color_jitter_strength, impl=impl)
...
def preprocess_image(image, height, width, is_training=False, color_distort=True, test_crop=True):
    ...
    #test_crop: whether or not to extract a central crop of the images (as for standard ImageNet evaluation) during the eval
